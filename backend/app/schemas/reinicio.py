...
- Usar ConfigDict(from_attributes=True) o model_config = ConfigDict(...)
"""
...
class ReinicioMesEligibilityResponse(BaseModel):
    """Indica si el usuario puede reiniciar mes (no pendientes KPI)."""
...
class CierrePreviewOut(BaseModel):
    ...
    # Opcionales (cuando el cálculo los provee)
